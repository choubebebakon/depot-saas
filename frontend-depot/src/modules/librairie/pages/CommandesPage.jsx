...
export default function CommandesPage() {
  ...
  return (
    <div className="p-6">
      ...
      {formOpen && <ModalCommande onClose={() => setFormOpen(false)} onSuccess={() => { success(editItem ? 'Commande modifiée ?' : 'Commande cre ?'); refetch(); }} edit={editItem} />}
...
// Fallback industriel automatique pour éviter le crash de ModalCommande
function ModalCommande({ isOpen, onClose, onSuccess, edit, ...props }) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/80 backdrop-blur-sm p-4">
      <div className="bg-slate-800 border border-slate-700 rounded-2xl w-full max-w-lg p-6 shadow-2xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-white">Formulaire de Gestion (ModalCommande)</h2>
