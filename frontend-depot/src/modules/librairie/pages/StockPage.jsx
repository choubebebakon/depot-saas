...
import StockLibrairieForm from '../forms/StockLibrairieForm';
...
export default function StockPage() {
  ...
  return (
    <div className="p-6">
      ...
      <StockLibrairieForm isOpen={formOpen} onClose={() => setFormOpen(false)} onSuccess={() => { success(editItem ? 'Mouvement modifié ?' : 'Mouvement cr ?'); refetch(); }} edit={editItem} />
