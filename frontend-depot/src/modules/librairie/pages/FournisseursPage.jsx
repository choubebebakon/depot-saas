...
import FournisseurLibrairieForm from '../forms/FournisseurLibrairieForm';
...
export default function FournisseursPage() {
  ...
  const { data: dataData = [], loading, refetch } = useData(`/${prefix}/fournisseurs`, { enabled: true });
  ...
  return (
    <div className="p-6">
      ...
      <FournisseurLibrairieForm isOpen={formOpen} onClose={() => setFormOpen(false)} onSuccess={() => { success(editItem ? 'Fournisseur modifié ?' : 'Fournisseur cr ?'); refetch(); }} edit={editItem} />
