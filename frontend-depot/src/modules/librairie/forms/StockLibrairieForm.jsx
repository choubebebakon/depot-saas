...
export default function StockLibrairieForm({ isOpen, onClose, onSuccess, edit, metier = 'librairie' }) {
  ...
  useEffect(() => {
    if (edit) setForm({ article: edit.article || '', quantite: edit.quantite || '', prix: edit.prix || '' });
    else setForm({ ...initialState });
  }, [edit, isOpen]);
  const prefix = `/${metier}`;
  const validate = () => { const errs = {}; if (!form.article) errs.article = "L'article est requis"; return errs; };
