...
export default function ClientLibrairieForm({ isOpen, onClose, onSuccess, edit, metier = 'librairie' }) {
  ...
  return (
    <FormModal isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit} title={edit ? '✏️ Modifier' : '➕ Nouveau'} loading={loading} size="md" submitLabel={edit ? 'Modifier' : 'Créer'}>
      ...
      <FormField label="Nom *" name="nom" value={form.nom} onChange={set('nom')} required error={errors.nom} placeholder="Nom du client" />
