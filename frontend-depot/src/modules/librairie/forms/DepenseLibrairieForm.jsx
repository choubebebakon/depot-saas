...
export default function DepenseLibrairieForm({ isOpen, onClose, onSuccess, edit, metier = 'librairie' }) {
  ...
  useEffect(() => {
    if (edit) setForm({ libelle: edit.libelle || '', montant: edit.montant || '', date: edit.date || '', categorie: edit.categorie || 'FOURNITURES' });
