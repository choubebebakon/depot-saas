  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { icon: '💰', label: 'Ventes', value: `${(rapport?.totalVentes || 0).toLocaleString()} F`, color: '#10b981' },
          { icon: '💸', label: 'Dépenses', value: `${(rapport?.totalDepenses || 0).toLocaleString()} F`, color: '#ef4444' },
          { icon: '🥖', label: 'Production', value: `${(rapport?.production || 0)} unités`, color: '#d97706' },
