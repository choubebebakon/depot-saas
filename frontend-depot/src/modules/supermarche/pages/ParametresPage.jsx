...
export default function ParametresPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-black text-white flex items-center gap-2"><Settings className="w-6 h-6" /> Paramètres du Dépôt</h1>
        <p className="text-slate-400 text-sm mt-1">Gérez les informations de votre dépôt de boissons</p>
      </div>

      <Section title="Informations du Dépôt" icon={<Store className="w-5 h-5" />}>
      ...
      <Section title="Ticket de caisse (80mm)" icon={<Receipt className="w-5 h-5" />}>
