...
return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { icon: '📦', label: 'Colis en transit', value: stats?.colisEnTransit || 0, color: '#f97316' },
          { icon: '🚛', label: 'Trajets du jour', value: stats?.trajetsJour || 0, color: '#10b981' },
          { icon: '💰', label: 'Recettes du jour', value: `${(stats?.recettesJour || 0).toLocaleString('fr-FR')} F`, color: '#3b82f6' },
          { icon: '🚚', label: 'Flotte active', value: stats?.flotteActive || 0, color: '#8b5cf6' },
        ].map((k, i) => (
