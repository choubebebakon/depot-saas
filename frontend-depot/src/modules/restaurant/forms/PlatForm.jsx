...
export default function PlatForm({ isOpen, onClose, onSuccess, edit, metier = 'restaurant' }) {
  ...
  return (
    <FormModal isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit} title={edit ? 'Modifier plat' : 'Nouveau plat'} loading={loading} size="lg" submitLabel={edit ? 'Modifier' : 'Créer'}>
