  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div><h1 className="text-2xl font-black text-white">Mouvements de Stock</h1><p className="text-slate-400 text-sm mt-1">{totalItems} mouvement{totalItems !== 1 ? 's' : ''}</p></div>
      ...
      <ConfirmModal isOpen={!!confirmDelete} onConfirm={handleDelete} onCancel={() => setConfirmDelete(null)} loading={deleting} title="Supprimer le mouvement" message={`Supprimer ce mouvement de stock ? Cette action est irrversible.`} />
    </div>
  );
}
