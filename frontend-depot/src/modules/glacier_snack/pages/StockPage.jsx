...
export default function StockPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between"><div><h1 className="text-3xl font-black text-white tracking-tight">Stock</h1><p className="text-slate-400 text-sm">{totalItems} article(s)</p></div>
      ...
      <StockGlacierForm isOpen={formOpen} onClose={() => setFormOpen(false)} onSuccess={refetch} edit={editItem} />
