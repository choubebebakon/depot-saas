...
export default function FidelitePage() {
  ...
  const { data: dataData = [], loading, refetch } = useData(`/${prefix}/fidelite`, { enabled: true });
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div><h1 className="text-3xl font-black text-white tracking-tight">Fidélité</h1><p className="text-slate-400 text-sm">{totalItems} client(s) fidélité</p></div>
      ...
      <FideliteParfumerieForm isOpen={showForm} onClose={() => { setShowForm(false); }} onSuccess={refetch} />
    </div>
  );
}
