...
export default function ProduitsPage() {
  ...
  const { data: dataData = [], loading, refetch } = useData(`/${prefix}/produits`, { enabled: true });
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div><h1 className="text-3xl font-black text-white tracking-tight">Produits</h1><p className="text-slate-400 text-sm">{totalItems} produit(s)</p></div>
      ...
      <ProduitParfumerieForm isOpen={showForm} onClose={() => { setShowForm(false); setEdit(null); }} onSuccess={refetch} edit={edit} />
