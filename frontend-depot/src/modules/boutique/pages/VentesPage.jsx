            ...
            <tbody className="divide-y divide-slate-700/50">
              ...
              : paginated.map(i => (
                <tr key={i.id} className="hover:bg-slate-700/20 transition-colors">
                  <td className="px-5 py-4 text-white font-semibold text-sm">{i.produit}</td>
                  <td className="px-5 py-4 text-right text-white">{i.quantite}</td>
                  <td className="px-5 py-4 text-right text-slate-300">{(i.prixUnitaire || 0).toLocaleString('fr-FR')} F</td>
