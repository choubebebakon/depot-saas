...
export default function FournisseurBoutiqueForm({ isOpen, onClose, onSuccess, edit, metier = 'boutique' }) {
  ...
  return (
    <FormModal isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit} title={edit ? 'Modifier' : 'Nouveau Fournisseur'} loading={loading} size="md" submitLabel={edit ? 'Modifier' : 'Créer'}>
