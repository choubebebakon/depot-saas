...
export default function ParametresPage() {
  ...
  const [notif, setNotif] = useState(null); const [logoBase64, setLogoBase64] = useState(null);
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: async () => { await Promise.all([queryClient.invalidateQueries({ queryKey: ['depot-parametres', tenantId] }), queryClient.invalidateQueries({ queryKey: ['tenant-config', tenantId] })]); setNotif({ msg: 'Paramètres sauvegardés avec succès ✓', type: 'success' }); setTimeout(() => setNotif(null), 3000); },
