import { Coins, AlertTriangle, Truck, Landmark, Users, Car } from 'lucide-react';

export const DASHBOARD_WIDGETS = [
  { id: 'ventes_jour',      label: 'Ventes du jour',       icon: Coins, color: '#10b981', apiPath: '/depot-boissons/stats/ventes-jour' },
  ...
  { id: 'caisse_jour',      label: 'Caisse du jour',       icon: Landmark, color: '#8b5cf6', apiPath: '/depot-boissons/stats/caisse-jour' },
