...
export default function AvariesPage() {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            // Filtrer uniquement les avaries si l'API ne le fait pas déjà
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess('Avarie signalée avec succès. Le stock a été mis à jour.');
            setArticleId('');
            setQuantite(1);
            setMotif('');
            setPhotoUrl('');
                ...
                <div className="lg:col-span-12 xl:col-span-5">
                    <div className="bg-slate-950 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-xl font-black text-white mb-6 flex items-center gap-3">
                            <span className="p-2 bg-red-500/10 rounded-xl text-red-500">⚠️</span>
                            Signaler une perte
                        </h2>
                        ...
                        {success && <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-2xl text-xs font-bold font-mono">✅ {success}</div>}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            >
                                {submitting ? '...' : '📉 Soustraire du Stock'}
                            </button>
                        </form>
                    </div>
                </div>
