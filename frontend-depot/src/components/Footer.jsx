import { Mail, Phone, Globe, Link2, Lock, Server, CheckCircle, ExternalLink } from 'lucide-react';
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col footer-brand">
            ...
            <div className="contact-info">
              ...
              <a href="https://wa.me/237688002284" target="_blank" rel="noopener noreferrer" className="contact-link">
                <Phone size={18} />
                <span>+237 688002284</span>
              </a>
            </div>
